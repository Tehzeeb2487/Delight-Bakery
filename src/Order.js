        ...
        <div class="form">
            ...
            <form className="px-5" onSubmit={handleSubmit}>
                <div class="row my-3">
                    ...
                    <div class="col">
                        <label  htmlFor="num">Contact no<span> *</span></label>
                        <input 
                            type="number" 
                            class="form-control" 
                            name="num"
                ...
                <div class="my-3">
                    ...
                    >
                        ...
                        <option value="New York Style Baked Cheesecake">New York Style Baked Cheesecake</option>
                        <option value="Eggless Chocolate Mousse Cake">Eggless Chocolate Mousse Cake</option>
                        <option value="Hazelnut Praline Mousse Cake">Hazelnut Praline Mousse Cake</option>
                    </select>
                ...
                <button type="submit" className="rounded-pill mt-3 card-btn bttn">Submit</button>
            </form>
            <div className="px-5">
